			...
			<div class="col-lg-6">
				...
				<form id="contactForm" action="${pageContext.request.contextPath }/loginDo" method="post" data-sb-form-api-token="API_TOKEN">
					...
					<div class="form-floating mb-3">
						<input class="form-control" id="id" type="text" name="memId"
					...
					<!-- 비밀번호 input -->
					<div class="form-floating mb-3">
						<input class="form-control" id="password" type="memPw" name="memPw"
					...
					<div class="d-grid mt-3">
						<button class="btn btn-primary btn-xl" id="submitButton"
							type="submit" style="font-size:30px;">login</button>
					</div>
				</form>
			</div>
		</div>

		...
		<div class="container pt-5">
			...
			<div class="row justify-content-center">
		 		<div class="col-lg-8 col-xl-7">
					...
					<form action="${pageContext.request.contextPath }/reservationEditDo" method="POST" >
						<input type="hidden" name="reservationNo" value="${reservation.reservationNo }">
						<div class="mb-3">
							<input class="form-control" type="text" name="reservationTitle"  value="${reservation.reservationTitle }" />					
						</div>
						
						<div class="mb-3">
							<textarea class="form-control" rows="10" name="reservationContent" >${reservation.reservationContent }</textarea>					
						</div>
